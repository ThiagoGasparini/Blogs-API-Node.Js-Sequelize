...
<br />
  ...
  **Foi necessário configurar as variáveis de ambiente para uso do MySQL.** 
  
  O arquivo a seguir, contém um modelo das variáveis de ambiente utilizadas no projeto. 
...
JWT_SECRET=suaSenhaSecreta
  ...
  Esta variável de ambiente foi utilizada tanto para criar o token quanto para verificá-lo. 
...
<details>
  ...
  Foi utilizado no projeto o `ORM Sequelize` para criar e atualizar o banco de dados. 

  Os primeiros requisitos do projeto foram orientar a produção das migrations para gerar:
